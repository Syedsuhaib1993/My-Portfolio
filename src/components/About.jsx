    ...
    >
      <div className="max-w-6xl w-full grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-center">
        ...
        >
          ...
          I’m a passionate Frontend Developer with a strong focus on creating clean, responsive, 
          and user-friendly interfaces. I specialize in turning complex design concepts into functional,
           interactive web experiences  using technologies like HTML, CSS, JavaScript, and modern frameworks such as React
          </p>
          <footer>
            <button
